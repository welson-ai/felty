# Felty - Emotional Wellness Companion

## Overview

Felty is a gamified emotional journaling app that helps you track how you feel every day and reflect on your emotions. The goal is to make emotional awareness fun, insightful, and safe.
...
Gamification is a core part of Felty. Logging emotions earns points, unlocking badges and achievements that encourage consistent tracking and reflection. This makes emotional journaling more engaging and rewarding.

Privacy-first with Stellar & Web ZK: Felty uses Stellar network for decentralized rewards and Web Zero-Knowledge proofs to ensure anonymity. Users can post within their teams or on the global mood wall without revealing their identities, while admins can access aggregate insights safely. This system guarantees that sensitive emotional data stays private while still providing meaningful analytics.

Felty is perfect for anyone who wants to understand themselves better, reflect on their feelings, and connect safely with a community while keeping their emotions private.
...
- Client-side authentication with authClient
- Server-side API endpoints with token verification
...
Felty leverages the Stellar network for decentralized identity and rewards:
